        ...
        return (
          <div>
            ...
            <textarea
              ...
              onChange={(e) =>
                setFormData({ ...formData, lifeStory: e.target.value })
              }
            ...
            <p className="text-sm text-gray-600 mt-2">
              The more detail you provide, the richer your autobiography will
              be.
            </p>
          </div>
        );
        ...
        return (
          <div>
            ...
            <textarea
              ...
              onChange={(e) =>
                setFormData({ ...formData, keyMoments: e.target.value })
              }
          ...
          <div className="text-center">
            <div className="border-2 border-dashed border-black p-12 rounded-lg bg-gray-50">
              ...
              <p className="text-gray-600 mb-6">
                Upload an audio file so we can match your voice for the
                audiobook narration
              </p>
              <input
                type="file"
